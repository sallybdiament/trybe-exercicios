...
function mostrarP() {
    ...
    let parag = document.getElementsByTagName("p"); //se eu coloco isso antes, ele diz erro "document is not defined" e se eu coloco aqui, ele nao le o length pq a variável nao existe antes.
